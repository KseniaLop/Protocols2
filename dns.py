...
def get_info(domain, info_data, qtype):
    ...
    if info_name in info_data:
        print(f'{info_name.rstrip(".")}: Данные в кэше.')
...
def build_response(data):
    ...
    print(f'Ответ про "{ ".".join(domain) }" отправлен.')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="DNS caching server in the name of all time deepest rapers - Zamay & Slava KPSS")
    parser.parse_args()
